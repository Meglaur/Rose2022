	...
	else
	{
		...
		switch (decision)
		{
			case 1:
				...
				break;
			case 2:
				cout << "You decided not to throw a coin into the fountain." << endl;
				Pause();
				break;
		}
	...
	if (Town.Hilda == false)
	{
		...
		switch (decision)
		{
			case 1:
				...
				break;
			case 2:
				cout << "You politely decline. She looks sad, and sends you on your way." << endl;
				Pause();
				break;
		}
	}
...
void handleTownBookshelf()
{
	if (Item.Cookbook == false)
	{
		...
		{
			case 1:
				cout << "You take the cookbook with you." << endl;
				Pause();
				Item.Cookbook = true;
				break;
			case 2:
				cout << "You decide to leave the book." << endl;
				Pause();
				break;
		}
	}
	...
	{
		cout << "You see a bookshelf filled with boring books." << endl;
		Pause();
	}
