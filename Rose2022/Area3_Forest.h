...
void Area_Forest()
{
	...
	if (gPosition == 34)
	{
		switch (gMove)
		{
			...
			case 2:
				...
				break;
			case 3:
				cout << "You see strange rune markings on the wall." << endl;
				Pause();
				if (Item.Book == true)
				{
					...
					if (Rune_34 == false)
					{
						cout << "Your Rune Book is updated!" << endl;
						Rune_34 = true;
						Pause();
					}
				}
	...
	if (gPosition == 35)
	{
		switch (gMove)
		{
			case 1:
				...
				{
					cout << "You strap on the mechanical wings and fly across the chasm." << endl;
					Pause();
					gPosition = 38;
					Debug();
					Move();
			...
			case 2:
				...
				break;
			case 3:
				cout << "You walk towards a doorway surrounded by two pillars of fire. The\nair gets warmer as you enter the room, and you feel slightly anxious." << endl;
				Pause();
				enemy = Enemy.Skeleton;
				RandomEnemyEncounter();
				gPosition = 37;
			...
			case 5:
				...
				Pause();
				cout << "You see strange rune markings on the floor." << endl;
				Pause();
				if (Item.Book == true)
				{
	...
	if (gPosition == 36)
	{
		switch (gMove)
		{
			...
			case 4:
				...
				break;
			case 5:
				cout << "You are standing on a platform surrounded by water. Each wall has\na set of four fountains, with a pedestal in the middle before each wall." << endl;
				Pause();
				cout << "You see strange rune markings on the floor." << endl;
				Pause();
				if (Item.Book == true)
	...
	if (gPosition == 38)
	{
		...
		{
			case 1:
				if (miniscene.NymphAppears == false)
				{
					miniScene_NymphAppears();
				}
			...
			case 3:
				...
				{
					cout << "You see an empty chest." << endl;
					Pause();
				}
	...
	if (gPosition == 39)
	{
		...
		{
			case 1:
				cout << "You go forward, the grass making your footsteps all but inaudible." << endl;
				Pause();
				gPosition = 394;
				Debug();
				Move();
			...
			case 2:
				break;
			case 3:
				cout << "You turn right, and pass under a willow tree, its leaves rustle gently." << endl;
				Pause();
				gPosition = 391;
				Debug();
				Move();
	...
	if (gPosition == 391)
	{
		switch (gMove)
		{
			case 1:
				...
				break;
			case 2:
				cout << "You go left, and pass under a willow tree, its leaves rustle gently." << endl;
				Pause();
				gPosition = 39;
				break;
			case 3:
				cout << "You go right, and continue over the dead leaves. They make loud\ncrunching sounds as you walk!" << endl;
				Pause();
				NymphFollow();
				gPosition = 392;
				Debug();
	...
	if (gPosition == 394)
	{
		switch (gMove)
		{
			...
			case 3:
				...
				break;
			case 4:
				cout << "You go backwards, the grass making your footsteps all but inaudible." << endl;
				Pause();
				gPosition = 39;
				break;
			case 5:
	...
	if (gPosition == 396)
	{
		...
		{
			case 1:
				cout << "You walk through the flower bed, the flowers are soft under your feet." << endl;
				Pause();
				gPosition = 3910;
				Debug();
				Move();
	...
	if (gPosition == 397)
	{
		...
		{
			case 1:
				cout << "You walk through the seemingly ordinary path. Nothing happens." << endl;
				Pause();
				gPosition = 3911;
				Debug();
				Move();
			...
			case 3:
				if (Crank == false)
				{
					cout << "You find a crank. It looks old, but might have some use." << endl;
					Pause();
					cout << "Take the crank?\n\n1. Yes\n2. No\n" << endl;
					...
					{
						case 1:
							cout << "You take the crank." << endl;
							DoublePause();
							Crank = true;
							break;
						case 2:
							cout << "You decide not to take the crank." << endl;
							DoublePause();
							break;
					}
				}
				...
				{
					cout << "You see an empty space. You picked up the crank from here." << endl;
					Pause();
				}
	...
	if (gPosition == 399)
	{
		...
		{
			case 1:
				cout << "You walk across the bank of sand. Its soft under your feet." << endl;
				Pause();
				gPosition = 3913;
				Debug();
				Move();
			...
			case 2:
				...
				break;
			case 3:
				cout << "You walk into a path filled with garden snakes." << endl;
				Pause();
				Character.Name = Player.Name;
				animationText = "*internally* Don't freak out, don't freak out!";
				Dialogue();
				cout << "You make it across safely and quietly." << endl;
				Pause();
				gPosition = 3910;
				Debug();
				Move();
	...
	if (gPosition == 3910)
	{
		switch (gMove)
		{
			...
			case 3:
				...
				Pause();
				Character.Name = Player.Name;
				animationText = "*whisper* n-no please!";
				Dialogue();
				Character.Name = "Cat";
				animationText = "*mew*";
				Dialogue();
				Character.Name = " ";
				animationText = "All the other cats look to the one. It seems to be their leader.";
				Dialogue();
				Character.Name = Player.Name;
				animationText = "Please no...";
				Dialogue();
				Character.Name = "Group of cats";
				animationText = "MEEEEEEOOOOOOOOOOOOOOOOOWWWWW!!!!";
				Dialogue();
				Character.Name = " ";
				animationText = "You run out of there.";
				Dialogue();
				NymphFollow();
				gPosition = 3911;
				Debug();
	...
	if (gPosition == 3911)
	{
		...
		{
			case 1:
				cout << "You walk through a field of wheat. It feels peaceful." << endl;
				Pause();
				gPosition = 3915;
				Debug();
				Move();
	...
	if (gPosition == 3912)
	{
		switch (gMove)
		{
			case 1:
					...
					if (Crank == true)
					{
						...
						switch (decision)
						{
							case 1:
								...
								break;
							case 2:
								cout << "You decide not to use the crank.";
								DoublePause();
								break;
						}
					}
				...
				{
					cout << "You see a waterfall leading into a river. The sound\nof rushing water fills your ears, drowning out all other sounds." << endl;
					Pause();
				}
			...
			case 2:
				break;
			case 3:
				cout << "You walk through a pathway filled with hanging lanterns. Its beautiful." << endl;
				Pause();
				gPosition = 3913;
				Debug();
				Move();
...
void NymphFollow()
{
	...
	if (miniscene.Dam == false)
	{
		...
		{
			case 391:
				if (nymphPosition == 39 || gPosition == 395 || gPosition == 392)
				{
					ForestNymphKillsYou();
				}
				else
				{
					cout << Text.NymphFollowMessage;
					Pause();
					nymphPosition = gPosition;
				}

				break;
			case 392:
				if (nymphPosition == 391 || gPosition == 393 || gPosition == 396)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 393:
				if (nymphPosition == 392 || gPosition == 397)
				{
					ForestNymphKillsYou();
					Pause();
				}
				...
				break;
			case 394:
				if (nymphPosition == 39 || gPosition == 395 || gPosition == 398)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 395:
				if (nymphPosition == 394 || gPosition == 396 || gPosition == 399)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 396:
				if (nymphPosition == 397 || gPosition == 395 || gPosition == 392 || gPosition == 3910)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 397:
				if (nymphPosition == 393 || gPosition == 396 || gPosition == 3911)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 398:
				if (nymphPosition == 394 || gPosition == 3912 || gPosition == 399)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 399:
				if (nymphPosition == 398 || gPosition == 3913 || gPosition == 3910 || gPosition == 395)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 3910:
				if (nymphPosition == 399 || gPosition == 3914 || gPosition == 3911 || gPosition == 396)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 3911:
				if (nymphPosition == 3910 || gPosition == 397 || gPosition == 3915)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 3912:
				if (nymphPosition == 38 || gPosition == 3913)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 3913:
				if (nymphPosition == 399 || gPosition == 3912 || gPosition == 3914)
				{
					ForestNymphKillsYou();
				}
				else
				...
				break;
			case 3914:
				if (nymphPosition == 3913 || gPosition == 3910 || gPosition == 3911)
				{
					ForestNymphKillsYou();
				}
				else
...
void DungeonWaterPuzzle()
{
	...
	{
		case 1:
			fountainOrder.Position1 = 3;
			fountainOrder.Position2 = 1;
			fountainOrder.Position3 = 4;
			fountainOrder.Position4 = 3;
			FountainOrder = 3143;
			break;
		case 2:
			fountainOrder.Position1 = 1;
			fountainOrder.Position2 = 3;
			fountainOrder.Position3 = 2;
			fountainOrder.Position4 = 1;
			FountainOrder = 1321;
			break;
		case 3:
			fountainOrder.Position1 = 2;
			fountainOrder.Position2 = 4;
			fountainOrder.Position3 = 1;
			fountainOrder.Position4 = 2;
			FountainOrder = 2412;
			break;
	}
		...
		switch (decision)
		{
			case 1:
				...
				if (rStatue == 0)
				{
					...
					if (eCrown == 5)
					{
						cout << "1. Use Emerald Crown\n" << endl;
					}

					if (sCrown == 5)
					{
						cout << "2. Use Sapphire Crown\n" << endl;
					}

					if (rCrown == 5)
					{
						cout << "3. Use Ruby Crown\n" << endl;
					}
					...
					switch (decision)
					{
						case 1:
							if (eCrown == 5)
							{
								cout << "You place the Emerald Crown on the womans head." << endl;
								DoublePause();
								rStatue = 1;
								eCrown = 1;
							}
						...
						case 2:
							if (sCrown == 5)
							{
								cout << "You place the Sapphire Crown on the womans head." << endl;
								DoublePause();
								rStatue = 1;
								sCrown = 1;
							}
						...
						case 3:
							if (rCrown == 5)
							{
								cout << "You place the Ruby Crown on the womans head." << endl;
								DoublePause();
								rCrown = 1;
								rStatue = 2;
							}
						...
						case 4:
							if (dCrown == 5)
							{
								cout << "You place the Diamond Crown on the womans head." << endl;
								DoublePause();
								rStatue = 1;
								dCrown = 1;
							}
				...
				else
				{
					...
					if (decision == 1)
					{
						...
						cout << "You take the crown off the statue." << endl;
						Pause();
					}
				}
				...
				if (sStatue == 0)
				{
					...
					switch (decision)
					{
						case 1:
							if (eCrown == 5)
							{
								cout << "You place the Emerald Crown on the mans head." << endl;
								DoublePause();
								sStatue = 1;
								eCrown = 2;
							}
						...
						case 2:
							if (sCrown == 5)
							{
								cout << "You place the Sapphire Crown on the mans head." << endl;
								DoublePause();
								sCrown = 2;
								sStatue = 2;
							}
						...
						case 3:
							if (rCrown == 5)
							{
								cout << "You place the Ruby Crown on the mans head." << endl;
								DoublePause();
								sStatue = 1;
								rCrown = 2;
							}
						...
						case 4:
							if (dCrown == 5)
							{
								cout << "You place the Diamond Crown on the mans head." << endl;
								DoublePause();
								sStatue = 1;
								dCrown = 2;
							}
...
void handleCrowns()
{
	...
	if (Crowns == true)
	{
		cout << "You see an empty marble shelf." << endl;
		Pause();
	}
	else
	{
		...
		if (eCrown == 0)
		{
			cout << "1. Emerald Crown" << endl;
		}

		if (sCrown == 0)
		{
			cout << "2. Sapphire Crown" << endl;
		}

		if (rCrown == 0)
		{
			cout << "3. Ruby Crown" << endl;
		}

		if (dCrown == 0)
		{
			cout << "4. Diamond Crown" << endl;
		}
		...
		switch (decision)
		{
			case 1:
				if (eCrown == 0)
				{
					cout << "You take the Emerald Crown from the shelf." << endl;
					Pause();
					eCrown = 5;
				}
			...
			case 2:
				if (sCrown == 0)
				{
					cout << "You take the Sapphire Crown from the shelf." << endl;
					Pause();
					sCrown = 5;
				}
			...
			case 3:
				if (rCrown == 0)
				{
					cout << "You take the Ruby Crown from the shelf." << endl;
					Pause();
					rCrown = 5;
				}
			...
			case 4:
				if (dCrown == 0)
				{
					cout << "You take the Diamond crown from the shelf." << endl;
					Pause();
					dCrown = 5;
				}
		...
		if (sCrown > 0 && eCrown > 0 && rCrown > 0 && dCrown > 0)
		{
			Crowns = true;
		}
...
void handleFirstFountain()
{
	...
	{
		cout << "The fountains are all on, they feel cool to stand near." << endl;
		Pause();
	}
}
...
void handleSecondFountain()
{
	...
	{
		cout << "Four Golden fountains are before you, but they don't seem to be working." << endl;
		Pause();
	}
}
