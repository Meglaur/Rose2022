...
void Area_ElfVillage()
{
	...
	void GetInput();
	void handleVillageShop();
	void handleVillageShopDialogue();
	void handleLoni();
	void handleKuhar();
	void handleTiki();
	void handleAida();
	...
	if (gPosition == 46)
	{
		...
		switch (gMove)
		{
			case 1:
				...
				break;
			case 2:
				cout << "The bed is perfectly made, and the blanket is covered in flower designs." << endl;
				Pause();
				break;
			case 3:
				gPosition = 45;
				break;
			case 4:
				cout << "You probably shouldn't steal from other people." << endl;
				Pause();
				break;
			case 5:
	...
	if (gPosition == 47)
	{
		switch (gMove)
		{
			case 1:
				...
				{
					cout << "You don't have access to that room!" << endl;
					Pause();
				}
...
void handleVillageShopDialogue()
{
	...
	if (Item.Jewel == true)
	{
		cout << "4. Would you be interested in buying a jewel?" << endl;
	}
...
void handleTiki()
{
	...
	if (Tiki == false)
	{
		...
		if (Item.Daisy == true)
		{
			...
			{
				cout << "You decide not to give her the daisy" << endl;
				Pause();
			}
		}
		else
...
void handleVillageBookshelf()
{
	...
	if (Item.Book == false)
	{
		...
		if (decision == 1)
		{
			cout << "You take the book with you! You can look at it by\nchoosing the book in the Use Item screen." << endl;
			DoublePause();
			Item.Book = true;
		}
		else
		{
			cout << "You decide not to take the book with you." << endl;
			DoublePause();
		}
	}
}
